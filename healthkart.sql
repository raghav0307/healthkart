...
CREATE TABLE `doctors` (
  ...
  CONSTRAINT `Doctors_ibfk_2` FOREIGN KEY (`DepartmentName`) REFERENCES `departments` (`DepartmentName`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `metadata` VALUES ('appointments',253),('doctors',10),('employees',23),('labtests',20),('medicines',142),('patients',28),('salts',50),('test_reports',118),('visits',200);
...
-- Dump completed on 2020-04-27 21:04:28
