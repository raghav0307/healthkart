...
CREATE TABLE `appointments` (
  ...
  KEY `APPOINTMENT_INDEX` (`DoctorID`,`VisitDate`),
...
CREATE TABLE `doctor_availability_chart` (
  ...
  KEY `DOCTOR_AVAILIBILITY_INDEX` (`Day`),
...
CREATE TABLE `doctors` (
  ...
  KEY `DOCTORS_INDEX` (`DepartmentName`),
  CONSTRAINT `Doctors_ibfk_1` FOREIGN KEY (`DoctorID`) REFERENCES `employees` (`EmployeeID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `Doctors_ibfk_2` FOREIGN KEY (`DepartmentName`) REFERENCES `departments` (`DepartmentName`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `employees` (
  ...
  `Occupation` enum('D','N','L','F','P','R') DEFAULT NULL,
  ...
  KEY `EMPLOYEES_INDEX` (`Occupation`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medicines` (
  ...
  KEY `idx_Quantity_Available` (`QuantityAvailable`),
...
INSERT INTO `medicines` VALUES ('M000000001','Synthroid',18,'2020-03-15',145,'C0001'),('M000000002','Levoxyl',6,'2020-05-10',162,'C0002'),('M000000003','Tirosint',12,'2024-09-06',295,'C0003'),('M000000004','Euthyrox',9,'2024-09-23',266,'C0004'),('M000000005','Zestril',15,'2020-02-15',268,'C0005'),('M000000006','Prinivil',13,'2024-08-03',298,'C0005'),('M000000007','Qbrelis',15,'2021-10-28',276,'C0006'),('M000000008','Lipitor',4,'2022-03-31',128,'C0007'),('M000000009','Glucophage',6,'2024-12-16',292,'C0004'),('M000000010','Glumetza',6,'2021-05-18',156,'C0007'),('M000000011','Glucophage XR',11,'2020-06-26',205,'C0002'),('M000000012','Riomet',8,'2022-05-05',130,'C0001'),('M000000013','Norvasc',12,'2020-06-04',152,'C0001'),('M000000014','Katerzia',15,'2023-10-18',194,'C0010'),('M000000015','Metoprolol Succinate ER',14,'2023-04-22',89,'C0008'),('M000000016','Metoprolol',6,'2020-02-01',122,'C0001'),('M000000017','Prilosec',18,'2020-08-24',105,'C0009'),('M000000018','Prilosec OTC',18,'2020-03-16',264,'C0008'),('M000000019','Omesec',7,'2022-07-28',242,'C0002'),('M000000020','Zegerid',19,'2020-11-12',75,'C0004'),('M000000021','Zocor',2,'2023-07-16',243,'C0002'),('M000000022','FloLipid',11,'2020-10-31',110,'C0008'),('M000000023','Cozaar',9,'2024-03-31',237,'C0010'),('M000000024','Ventolin',20,'2021-03-07',142,'C0005'),('M000000025','ProAir HFA',9,'2023-01-26',86,'C0009'),('M000000026','Ventolin HFA',4,'2021-11-03',166,'C0008'),('M000000027','Proventil',3,'2024-03-07',159,'C0003'),('M000000028','Neurontin',15,'2021-12-24',189,'C0003'),('M000000029','Gralise',20,'2021-07-14',152,'C0006'),('M000000030','Gabarone',18,'2021-07-09',227,'C0004'),('M000000031','Fanatrex',4,'2020-02-25',177,'C0003'),('M000000032','HydroDIURIL',16,'2021-05-30',94,'C0009'),('M000000033','Microzide',4,'2023-11-14',230,'C0005'),('M000000035','Oretic',16,'2021-11-20',82,'C0004'),('M000000036','Hysingla ER',13,'2021-06-21',182,'C0002'),('M000000037','Zohydro ER',13,'2021-06-24',232,'C0006'),('M000000038','Vantrela ER',13,'2022-01-09',219,'C0008'),('M000000039','Zoloft',5,'2022-01-29',188,'C0005'),('M000000041','Diaqua-2',10,'2020-04-28',261,'C0006'),('M000000042','Lo-Aqua',11,'2022-02-25',103,'C0005'),('M000000043','Flovent',14,'2022-02-03',296,'C0009'),('M000000044','Flovent HFA',17,'2024-03-25',153,'C0008'),('M000000045','Arnuity Ellipta',8,'2021-01-13',58,'C0008'),('M000000046','Flovent Diskus',17,'2024-06-16',246,'C0009'),('M000000047','Tylenol',13,'2023-05-13',232,'C0009'),('M000000048','Paracetamol',19,'2021-09-24',76,'C0003'),('M000000049','Panadol',15,'2024-12-24',54,'C0008'),('M000000050','Aceta',4,'2024-02-27',130,'C0003'),('M000000051','Amoxil',7,'2021-10-07',206,'C0001'),('M000000052','Trimox',10,'2022-07-27',154,'C0005'),('M000000053','Apo-Amoxi',3,'2022-06-17',230,'C0009'),('M000000054','Moxilin',9,'2020-08-25',253,'C0009'),('M000000055','Xanax',7,'2020-06-01',154,'C0010'),('M000000056','Xanax XR',14,'2021-08-09',198,'C0004'),('M000000057','Alprazolam Intensol',11,'2024-06-23',214,'C0006'),('M000000058','Niravam',16,'2020-09-08',146,'C0005'),('M000000059','Tenormin',14,'2022-06-26',62,'C0001'),('M000000060','Celexa',9,'2024-09-27',174,'C0003'),('M000000061','Basaglar',17,'2020-10-13',203,'C0010'),('M000000062','Lantus',8,'2023-07-21',280,'C0005'),('M000000063','Toujeo',7,'2023-03-14',146,'C0006'),('M000000064','Singulair',12,'2021-10-22',177,'C0003'),('M000000065','Desyrel',20,'2020-10-21',239,'C0009'),('M000000066','Oleptro',10,'2020-01-17',286,'C0004'),('M000000067','Desyrel Dividose',3,'2022-02-01',163,'C0004'),('M000000068','Protonix',10,'2024-10-30',208,'C0004'),('M000000069','Protonix IV',8,'2024-04-13',269,'C0010'),('M000000070','Lexapro',4,'2022-01-14',211,'C0007'),('M000000071','Pravachol',6,'2022-03-06',258,'C0001'),('M000000072','Wellbutrin',19,'2023-02-04',294,'C0010'),('M000000073','Wellbutrin XL',10,'2023-11-04',204,'C0010'),('M000000074','Wellbutrin SR',7,'2024-12-08',87,'C0008'),('M000000075','Zyban',13,'2021-09-05',161,'C0009'),('M000000076','Prozac',13,'2023-08-20',287,'C0001'),('M000000077','Sarafem',3,'2020-08-21',86,'C0001'),('M000000078','Prozac Weekly',11,'2022-04-25',82,'C0006'),('M000000079','Rapiflux',12,'2020-05-07',123,'C0008'),('M000000080','Coreg',20,'2023-04-20',69,'C0001'),('M000000081','Coreg CR',5,'2020-09-19',174,'C0009'),('M000000082','Deltasone',15,'2024-09-26',212,'C0005'),('M000000083','Rayos',15,'2022-11-17',101,'C0006'),('M000000084','Sterapred',13,'2021-02-26',52,'C0003'),('M000000085','Meticorten',19,'2021-03-26',166,'C0003'),('M000000086','Flomax',19,'2022-04-12',78,'C0010'),('M000000087','Plavix',20,'2022-01-06',114,'C0003'),('M000000088','Advil',6,'2022-06-11',242,'C0002'),('M000000089','Motrin',20,'2020-03-11',157,'C0005'),('M000000090','IBU',17,'2023-10-23',173,'C0004'),('M000000091','Motrin IB',3,'2023-07-21',185,'C0010'),('M000000092','Mobic',11,'2023-05-21',292,'C0007'),('M000000093','Vivlodex',14,'2022-06-03',254,'C0001'),('M000000094','Anjeso',9,'2022-03-05',52,'C0004'),('M000000095','Qmiiz ODT',6,'2021-11-14',163,'C0005'),('M000000096','Crestor',17,'2021-09-11',162,'C0006'),('M000000097','Ezallor',5,'2020-01-07',142,'C0006'),('M000000098','Ecotrin',18,'2024-10-03',230,'C0010'),('M000000099','Aspir 81',9,'2022-08-06',295,'C0004'),('M000000100','C0004 Aspirin',15,'2024-08-28',162,'C0002'),('M000000101','Ultram',8,'2021-07-25',281,'C0005'),('M000000102','Tramadol Hydrochloride ER',6,'2024-03-12',114,'C0010'),('M000000103','Tramal',9,'2024-02-02',112,'C0004'),('M000000104','Ryzolt',2,'2023-09-24',218,'C0005'),('M000000105','Ambien',13,'2021-02-26',132,'C0010'),('M000000106','Ambien CR',5,'2023-10-04',93,'C0001'),('M000000107','Intermezzo',4,'2020-01-06',282,'C0004'),('M000000108','Edluar',13,'2022-12-09',246,'C0002'),('M000000109','Coumadin',14,'2023-08-03',297,'C0010'),('M000000110','Jantoven',2,'2023-12-17',179,'C0007'),('M000000111','Klonopin',20,'2021-08-22',215,'C0003'),('M000000112','Klonopin Wafer',8,'2024-01-28',76,'C0004'),('M000000113','Inderal',14,'2021-09-20',113,'C0002'),('M000000114','Inderal LA',4,'2022-09-08',145,'C0010'),('M000000115','Hemangeol',4,'2023-02-09',126,'C0008'),('M000000116','Inderal XL',3,'2021-03-12',217,'C0004'),('M000000117','Glucotrol',19,'2024-08-14',151,'C0010'),('M000000118','Glucotrol XL',15,'2023-07-04',263,'C0009'),('M000000119','GlipiZIDE XL',10,'2021-09-23',183,'C0001'),('M000000120','Dexedrine',20,'2022-05-17',52,'C0003'),('M000000121','Zenzedi',20,'2021-01-31',248,'C0001'),('M000000122','ProCentra',10,'2021-02-21',86,'C0006'),('M000000123','Dextrostat',5,'2021-11-24',132,'C0007'),('M000000124','Flexeril',13,'2021-08-16',223,'C0003'),('M000000125','Fexmid',6,'2023-05-11',68,'C0003'),('M000000127','Comfort Pac with Cyclobenzaprine',14,'2021-01-11',167,'C0003'),('M000000128','Concerta',13,'2020-03-27',95,'C0010'),('M000000129','Ritalin',5,'2021-10-22',61,'C0007'),('M000000130','Daytrana',8,'2022-08-19',241,'C0008'),('M000000131','Quillivant XR',9,'2024-09-27',221,'C0010'),('M000000132','Cymbalta',2,'2020-12-29',227,'C0008'),('M000000133','Drizalma Sprinkle',19,'2020-08-12',91,'C0004'),('M000000134','Irenka',9,'2020-07-10',231,'C0001'),('M000000135','Zithromax',5,'2024-10-01',110,'C0006'),('M000000136','Azithromycin Dose Pack',11,'2023-02-01',293,'C0007'),('M000000137','Z-Pak',16,'2021-11-06',216,'C0004'),('M000000138','Zmax',4,'2022-03-06',204,'C0002'),('M000000139','Zantac',12,'2021-05-11',201,'C0003'),('M000000140','Zantac 150',20,'2022-05-15',139,'C0004'),('M000000141','Zantac Injection',2,'2022-08-08',230,'C0006'),('M000000143','Zantaflac',100,'2028-04-12',250,'C0006'),('M000000144','Zantaflac',100,'2028-04-12',250,'C0006'),('M000000145','Zantaflac',100,'2028-04-12',250,'C0006'),('M000000146','ZoomLac',60,'2022-04-12',120,'C0011');
...
CREATE TABLE `medrecommended` (
  ...
  KEY `MEDRECOMMENDED_INDEX` (`VisitID`),
...
INSERT INTO `metadata` VALUES ('appointments',258),('doctors',10),('employees',23),('labtests',20),('medicines',146),('patients',30),('salts',54),('test_reports',118),('visits',207);
...
--
-- Temporary table structure for view `patientage`
--

DROP TABLE IF EXISTS `patientage`;
/*!50001 DROP VIEW IF EXISTS `patientage`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `patientage` (
...
INSERT INTO `pharmaceutical_companies` VALUES ('C0001','Merck','9456394039'),('C0002','Pfizer','8728394034'),('C0003','Sanofi','9829432344'),('C0004','Bayer','8932479234'),('C0005','GSK','9783425433'),('C0006','AstraZeneca','9071927776'),('C0007','Johnson & Johnson','9024857166'),('C0008','Novartis','8904562354'),('C0009','Roche','8930715945'),('C0010','Gilead Sciences','8883645334'),('C0011','Dovolik','9876789789'),('C0012','CorVoLin','9806782352');
...
INSERT INTO `salts` VALUES ('S0017','Acetaminophen '),('S0054','Adderline'),('S0010','Albuterol'),('S0052','AlmonD'),('S0019','Alprazolam '),('S0005','Amlodipine'),('S0018','Amoxicillin '),('S0038','Aspirin '),('S0020','Atenolol '),('S0003','Atorvastatin'),('S0049','Azithromycin '),('S0028','Bupropion '),('S0030','Carvedilol '),('S0021','Citalopram '),('S0042','Clonazepam '),('S0034','Clopidogrel '),('S0046','Cyclobenzaprine '),('S0045','Dextroamphetamine/amphetamine salts '),('S0048','Duloxetine '),('S0026','Escitalopram '),('S0029','Fluoxetine '),('S0016','Fluticasone '),('S0015','Furosemide '),('S0011','Gabapentin '),('S0044','Glipizide '),('S0012','Hydrochlorothiazide '),('S0013','Hydrocodone/acetaminophen '),('S0035','Ibuprofen '),('S0022','Insulin glargine '),('S0001','Levothyroxine'),('S0002','Lisinopril'),('S0009','Losartan'),('S0036','Meloxicam '),('S0004','Metformin'),('S0047','Methylphenidate '),('S0006','Metoprolol'),('S0023','Montelukast '),('S0007','Omeprazole'),('S0025','Pantoprazole '),('S0033','Potassium '),('S0027','Pravastatin '),('S0031','Prednisone '),('S0043','Propranolol '),('S0050','Ranitidine '),('S0051','ResinE'),('S0037','Rosuvastatin '),('S0014','Sertraline '),('S0008','Simvastatin'),('S0032','Tamsulosin '),('S0053','Telmistran'),('S0039','Tramadol '),('S0024','Trazodone '),('S0041','Warfarin '),('S0040','Zolpidem ');
...
CREATE TABLE `test_reports` (
  ...
  CONSTRAINT `Test_Reports_ibfk_2` FOREIGN KEY (`TestName`) REFERENCES `labtests` (`TestName`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `testnormalresults` VALUES ('Anti Hepatitis B Core Antigen (AHBC)','M',5,16,3,4),('Anti Hepatitis B Core Antigen (AHBC)','M',17,40,2,4),('Anti Hepatitis B Core Antigen (AHBC)','M',41,80,3,4),('Anti Hepatitis B Core Antigen (AHBC)','F',5,16,2,5),('Anti Hepatitis B Core Antigen (AHBC)','F',17,40,2,4),('Anti Hepatitis B Core Antigen (AHBC)','F',41,80,1,4),('Anti Hepatitis B Core Antigen Total','M',5,16,2,5),('Anti Hepatitis B Core Antigen Total','M',17,40,3,4),('Anti Hepatitis B Core Antigen Total','M',41,80,2,5),('Anti Hepatitis B Core Antigen Total','F',5,16,1,4),('Anti Hepatitis B Core Antigen Total','F',17,40,1,4),('Anti Hepatitis B Core Antigen Total','F',41,80,3,4),('Calcium/Serum','B',5,16,3,5),('Calcium/Serum','B',17,40,2,5),('Calcium/Serum','B',41,80,2,4),('Complete Blood Count (CBC)','M',5,16,2,4),('Complete Blood Count (CBC)','M',17,40,1,5),('Complete Blood Count (CBC)','M',41,80,1,4),('Complete Blood Count (CBC)','F',5,16,1,4),('Complete Blood Count (CBC)','F',17,40,2,5),('Complete Blood Count (CBC)','F',41,80,2,5),('Cortisol','B',5,16,2,5),('Cortisol','B',17,40,1,5),('Cortisol','B',41,80,1,4),('Diabetic Profile','B',5,16,2,5),('Diabetic Profile','B',17,40,2,5),('Diabetic Profile','B',41,80,3,5),('Follicle Stimulating Hormone (FSH)','M',5,16,3,4),('Follicle Stimulating Hormone (FSH)','M',17,40,2,5),('Follicle Stimulating Hormone (FSH)','M',41,80,3,5),('Follicle Stimulating Hormone (FSH)','F',5,16,2,5),('Follicle Stimulating Hormone (FSH)','F',17,40,3,5),('Follicle Stimulating Hormone (FSH)','F',41,80,2,5),('FSH-LH','M',5,16,1,4),('FSH-LH','M',17,40,1,4),('FSH-LH','M',41,80,2,5),('FT3','B',5,16,3,5),('FT3','B',17,40,1,5),('FT3','B',41,80,1,4),('FT4','B',5,16,1,5),('FT4','B',17,40,2,4),('FT4','B',41,80,1,5),('Hba1c','B',5,16,1,4),('Hba1c','B',17,40,2,4),('Hba1c','B',41,80,3,4),('Iron Studies','B',5,16,1,4),('Iron Studies','B',17,40,3,5),('Iron Studies','B',41,80,3,4),('Kidpro (KFT)','B',5,16,2,5),('Kidpro (KFT)','B',17,40,3,4),('Kidpro (KFT)','B',41,80,1,4),('Lipid Profile','B',5,16,2,5),('Lipid Profile','B',17,40,2,4),('Lipid Profile','B',41,80,2,4),('Liver Function','B',5,16,2,5),('Liver Function','B',17,40,2,4),('Liver Function','B',41,80,2,5),('Luteinizing Hormone (LH)','B',5,16,2,4),('Luteinizing Hormone (LH)','B',17,40,2,4),('Luteinizing Hormone (LH)','B',41,80,3,5),('Sex Hormone Binding Globulin (SHBG)','M',5,16,3,5),('Sex Hormone Binding Globulin (SHBG)','M',17,40,2,4),('Sex Hormone Binding Globulin (SHBG)','M',41,80,2,4),('Sex Hormone Binding Globulin (SHBG)','F',5,16,1,4),('Sex Hormone Binding Globulin (SHBG)','F',17,40,1,4),('Sex Hormone Binding Globulin (SHBG)','F',41,80,1,5),('Thyroid Profile','B',5,16,2,5),('Thyroid Profile','B',17,40,2,4),('Thyroid Profile','B',41,80,2,4),('TSH','B',5,16,2,5),('TSH','B',17,40,3,5),('TSH','B',41,80,2,5),('Vitamin D Total (25 OH)','B',5,16,2,5),('Vitamin D Total (25 OH)','B',17,40,1,4),('Vitamin D Total (25 OH)','B',41,80,2,4);
...
CREATE TABLE `testsrecommended` (
  ...
  `Testname` varchar(50) NOT NULL,
  PRIMARY KEY (`VisitID`,`Testname`),
  KEY `TESTSRECOMMENDED_INDEX` (`VisitID`),
...
/*!50001 VIEW `patientage` AS select `patients`.`PatientID` AS `PatientID`,floor((to_days(current_timestamp()) - to_days(`patients`.`DOB`)) / 365) AS `age` from `patients` */;
...
-- Dump completed on 2020-04-30  0:11:32
