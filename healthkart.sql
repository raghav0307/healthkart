...
--
-- Temporary view structure for view `patientage`
--
...
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `patientage` AS SELECT 
 1 AS `PatientID`,
 1 AS `age`*/;
...
/*!50001 VIEW `patientage` AS select `patients`.`PatientID` AS `PatientID`,floor(((to_days(now()) - to_days(`patients`.`DOB`)) / 365)) AS `age` from `patients` */;
...
-- Dump completed on 2020-04-29 17:25:51
